...

{
  ...
  class CartProduct {
    ...
    getElements(element) {
      ...
      thisCartProduct.dom = select.cartProduct.amountWidget;
      thisCartProduct.dom = select.cartProduct.edit;
      thisCartProduct.dom = select.cartProduct.price;
      thisCartProduct.dom = select.cartProduct.remove;
    }
  }
